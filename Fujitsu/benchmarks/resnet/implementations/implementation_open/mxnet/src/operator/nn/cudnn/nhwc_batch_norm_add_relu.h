...
class NhwcBatchNormAddRelu {
 public:
  ...
  void init_params(int new_pixels_per_thread_in_smem_fwd);
  dim3 calc_fwd_grid(int device_id, int *loop, bool use_group_bn);
  dim3 calc_bwd_grid(int device_id, int *loop, bool use_group_bn);
...
void NhwcBatchNormAddRelu::init_params(int new_pixels_per_thread_in_smem_fwd) {

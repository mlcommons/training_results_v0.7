...
class BaseModule(object):
    ...
    # High Level API
    ################################################################################
    def forward_backward(self, data_batch, cac_gradient_skip_dict=None, cac_stop_layer_num=-1,
                         cac_non_stop_layer_num=-1):
        """A convenient function that calls both ``forward`` and ``backward``."""
        self.forward(data_batch, is_train=True)
        self.backward(out_grads=None, cac_gradient_skip_dict=cac_gradient_skip_dict,

...
class DataGenerator(object):
  ...
  def __init__(self,params):
   ...
   # print ('num of training samples:', num_training_samples)
    num_training_samples = 1281167
    params['num_training_samples'] = 1281167
...
#    params['total_steps'] = ( params['train_epochs'] // params['eval_interval_epochs'] ) * params['total_steps_per_eval']
    ...
    eval_count = ( params['train_epochs'] // params['eval_interval_epochs'] ) * params['eval_steps_per_epoch']
    params['total_steps'] = ( params['total_training_steps'] ) + eval_count

...
class Evaluator {
 ...
 public:
  ...
  void Run() {
    ...
    outfile.open("train.log", std::ios_base::app);
    std::time_t t = std::time(0);
    outfile << ":::MLLOG {\"namespace\": \"worker1\", \"time_ms\": "
            << t
            << ", \"event_type\": \"POINT_IN_TIME\", \"key\": \"resign_threshold\", \"value\": "
            << game_options_.resign_threshold
            << ", \"metadata\": {\"file\": \"eval.cc\", \"lineno\": 177}}"
            << "\n";
    outfile.close();

#!/bin/bash
#
# Pls refer the orignal mlperf design & parameters
# to use the script for single node:
#   run_and_time.sh

source config_PAIEFLOPS.sh

#adjust based on node
#config_Multi_n**.sh
source config_Multi.sh
...
NTASKS_PER_NODE=${NTASKS_PER_NODE:-$PAIEFLOPSNGPU}

...
export DGXNGPU=8          # number of GPUs to be used for the test
export DGXSOCKETCORES=26  # number of CPU cores per CPU socket
export DGXHT=2            # hyper-threading (HT) is on is 2, HT off is 1

...
from REDACTED.transformer_lingvo.google.ops import beam_search_tpu_ops
...
class BeamSearchTpuHelper(base_layer.BaseLayer):
  ...
  def BeamSearchDecode(self,
    ...
    rets_decode = self._BeamSearchDecodeIds(theta, encoder_outputs,
                                            num_hyps_per_beam,
                                            init_beam_search_state,
                                            pre_beam_search_step_callback,
                                            post_beam_search_step_callback,
                                            max_steps)
    return rets_decode

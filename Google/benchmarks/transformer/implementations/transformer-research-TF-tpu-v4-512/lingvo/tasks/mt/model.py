...
from REDACTED.transformer_lingvo.lingvo.core import insertion
from REDACTED.transformer_lingvo.lingvo.core import metrics
from REDACTED.transformer_lingvo.lingvo.core import ml_perf_bleu_metric
from REDACTED.transformer_lingvo.lingvo.core import py_utils
from REDACTED.transformer_lingvo.lingvo.tasks.mt import decoder
from REDACTED.transformer_lingvo.lingvo.tasks.mt import encoder
...
class MTBaseModel(base_model.BaseTask):
  ...
  def PostProcessDecodeHost(self, metrics_dict):
    ...
    ret_ids = self.dec.BeamSearchDecodePostProcess(
        p.decoder.beam_search.num_hyps_per_beam, p.decoder.target_seq_len,
        r1_shape, r2_shape, r3_shape, metrics_dict['hyps'],
        metrics_dict['prev_hyps'], metrics_dict['done_hyps'],
        metrics_dict['scores'], metrics_dict['atten_probs'],
        metrics_dict['eos_scores'], metrics_dict['eos_atten_probs'],

...
from REDACTED.transformer_lingvo.lingvo.core import base_decoder
...
from REDACTED.transformer_lingvo.lingvo.core import layers_with_attention
from REDACTED.transformer_lingvo.lingvo.core import model_helper
from REDACTED.transformer_lingvo.lingvo.core import plot
...
from REDACTED.transformer_lingvo.lingvo.core import rnn_layers
...
class MTBaseDecoder(base_decoder.BaseBeamSearchDecoder):
  ...
  def Params(cls):
    ...
    p.Define(
        'feed_attention_context_vec_to_softmax', False,

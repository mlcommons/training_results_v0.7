...
.. code-block:: bash
  ...
  $ REDACTED build -c opt //third_party/py/lingvo:trainer
  $ REDACTED-bin/third_party/py/lingvo/trainer --logtostderr \
...
from REDACTED.tensorflow.python.tpu import device_assignment as device_assignment_lib
...
from REDACTED.transformer_lingvo.google.trainer import base_runner
from REDACTED.transformer_lingvo.lingvo import base_trial
from REDACTED.transformer_lingvo.lingvo import datasets
from REDACTED.transformer_lingvo.lingvo import executor
from REDACTED.transformer_lingvo.lingvo import model_imports
...
from REDACTED.transformer_lingvo.lingvo.core import inference_graph_exporter

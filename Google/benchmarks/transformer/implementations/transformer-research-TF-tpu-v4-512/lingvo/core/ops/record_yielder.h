...
#include "REDACTEDsubmissions/training/v0_7/models/prod/transformer_lingvo/lingvo/core/ops/rope.h"
...
class RecordIterator {
 public:
  ...
  virtual bool ResetIterator(bool randomize_location) { return false; }

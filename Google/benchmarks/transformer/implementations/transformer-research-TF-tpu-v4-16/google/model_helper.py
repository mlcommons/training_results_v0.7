...
from REDACTED.tensorflow_models.mlperf.models.rough.transformer_lingvo.lingvo.core import model_helper as lingvo_model_helper
...
from REDACTED.tensorflow_models.mlperf.models.rough.transformer_lingvo.google import beam_search_tpu_helper
...
def ChangeToBeamSearchTpuHelper(beam_search_helper_params):
  ...
  tf.logging.info('Running BeamSearchTpuHelper with params: %s ',
                       p.ToText())
  return p

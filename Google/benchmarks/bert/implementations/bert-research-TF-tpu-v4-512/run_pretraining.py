...
from REDACTED.bert import dataset_input
from REDACTED.bert import modeling
from REDACTED.bert import optimization
...
def get_masked_lm_output(bert_config, input_tensor, output_weights, positions,
                         label_ids, label_weights, num_partitions=1):

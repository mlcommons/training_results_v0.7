...
# pylint: disable=invalid-name,superfluous-parens,missing-docstring,g-doc-args,g-complex-comprehension,undefined-variable,unused-variable
...
from REDACTED.minigo.cluster.evaluator import launch_eval

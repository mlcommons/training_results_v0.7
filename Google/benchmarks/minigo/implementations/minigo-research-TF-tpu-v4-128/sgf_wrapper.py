...
# pylint: disable=missing-docstring,g-doc-return-or-yield,dangerous-default-value,g-multiple-import, g-doc-args,unused-argument, redefined-outer-name
...
def get_sgf_root_node(sgf_contents):
  collection = sgf.parse(sgf_contents)  # pylint: disable=undefined-variable
...
def replay_sgf(sgf_contents):
  ...
  while pos is not None and current_node.next is not None:
    ...
    yield go.PositionWithContext(pos, next_move, result)

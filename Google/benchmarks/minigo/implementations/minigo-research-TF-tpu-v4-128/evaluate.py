...
# pylint: disable=missing-docstring,invalid-name,superfluous-parens,g-doc-args,unused-argument, redefined-outer-name
...
def main(argv):
  ...
  play_match(black_model, white_model, FLAGS.num_evaluation_games,
             FLAGS.eval_sgf_dir)

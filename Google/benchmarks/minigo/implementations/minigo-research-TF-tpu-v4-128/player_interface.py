...
# pylint: disable=missing-docstring,g-multiple-import,g-importing-member,g-doc-return-or-yield,dangerous-default-value,g-doc-args
...
class MCTSPlayerInterface(PlayerInterface):
  ...
  def tree_search(self, parallel_readouts=None):
    ...
    Args:
      parallel_readouts: number of leaves to expand in parallel. If None, the
        number of parallel readouts, the player is free to choose a sensible
        default.

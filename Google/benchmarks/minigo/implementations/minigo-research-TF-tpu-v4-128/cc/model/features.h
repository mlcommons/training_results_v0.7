...
#ifndef MLPERF_SUBMISSIONS_TRAINING_V0_7_MODELS_PROD_MINIGO_CC_MODEL_FEATURES_H_
#define MLPERF_SUBMISSIONS_TRAINING_V0_7_MODELS_PROD_MINIGO_CC_MODEL_FEATURES_H_
...
#include "REDACTEDsubmissions/training/v0_7/models/prod/minigo/cc/model/features_internal.h"
...
// StoneFeatures must be listed first.
using Mlperf07Features = Features<StoneFeatures<4>, ToPlayFeature,
                                  LibertyFeatures, WouldCaptureFeature>;
...
#endif  //  MLPERF_SUBMISSIONS_TRAINING_V0_7_MODELS_PROD_MINIGO_CC_MODEL_FEATURES_H_

...
"""SacreBLEU provides hassle-free computation of shareable, comparable, and reproducible BLEU scores. Inspired by Rico Sennrich's `multi-bleu-detok.perl`, it produces the official WMT scores but works with plain text.
...
DATASETS = {
    ...
    'mtnt1.1/valid': {
        ...
        'description':
            'Validation data for the Machine Translation of Noisy Text task: '
            'http://www.cs.cmu.edu/~pmichel1/mtnt/',
        'citation':
            '@InProceedings{michel2018a:mtnt,\n    author = "Michel, Paul and '
            'Neubig, Graham",\n    title = "MTNT: A Testbed for Machine '
    ...
    'mtnt1.1/train': {
        ...
        'description':
            'Training data for the Machine Translation of Noisy Text task: '
            'http://www.cs.cmu.edu/~pmichel1/mtnt/',
        'citation':
            '@InProceedings{michel2018a:mtnt,\n    author = "Michel, Paul and '
            'Neubig, Graham",\n    title = "MTNT: A Testbed for Machine '
    ...
    'wmt17': {
        ...
        'citation':
            ...
            'Ond\\v{r}ej  and  Chatterjee, Rajen  and  Federmann, Christian  '
            'and  Graham, Yvette  and  Haddow, Barry  and  Huang, Shujian  and'
            '  Huck, Matthias  and  Koehn, Philipp  and  Liu, Qun  and  '
            'Logacheva, Varvara  and  Monz, Christof  and  Negri, Matteo  and'
            '  Post, Matt  and  Rubino, Raphael  and  Specia, Lucia  and  '
            'Turchi, Marco},\n  title     = {Findings of the 2017 Conference '
            'on Machine Translation (WMT17)},\n  booktitle = {Proceedings of '
            'the Second Conference on Machine Translation, Volume 2: Shared '
            'Task Papers},\n  month     = {September},\n  year      = '
    ...
    'wmt17/ms': {
        ...
        'citation':
            ...
            '  author = {Hassan Awadalla, Hany and Aue, Anthony and Chen, '
            'Chang and Chowdhary, Vishal and Clark, Jonathan and Federmann, '
            'Christian and Huang, Xuedong and Junczys-Dowmunt, Marcin and '
            'Lewis, Will and Li, Mu and Liu, Shujie and Liu, Tie-Yan and Luo, '
            'Renqian and Menezes, Arul and Qin, Tao and Seide, Frank and Tan, '
            'Xu and Tian, Fei and Wu, Lijun and Wu, Shuangzhi and Xia, Yingce '
            ...
            'advances in recent years. Millions of people are using it today '
            'in online translation systems and mobile applications in order to'
            ' communicate across language barriers. The question naturally '
            'arises whether such systems can approach or achieve parity with '
            'human translations. In this paper, we first address the problem '
            'of how to define and accurately measure human parity in '
            'translation. We then describe Microsoft’s machine translation '
            'system and measure the quality of its translations on the widely '
            'used WMT 2017 news translation task from Chinese to English. We '
            'find that our latest neural machine translation system has '
            'reached a new state-of-the-art, and that the translation quality '
            'is at human parity when compared to professional human '
            'translations. We also find that it significantly exceeds the '
    ...
    'wmt16': {
        ...
        'citation':
            ...
            '  Jimeno Yepes, Antonio  and  Koehn, Philipp  and  Logacheva, '
            'Varvara  and  Monz, Christof  and  Negri, Matteo  and  Neveol, '
            'Aurelie  and  Neves, Mariana  and  Popel, Martin  and  Post, Matt'
            '  and  Rubino, Raphael  and  Scarton, Carolina  and  Specia, '
            'Lucia  and  Turchi, Marco  and  Verspoor, Karin  and  Zampieri, '
    ...
    'wmt15': {
        ...
        'citation':
            ...
            'Ond\\v{r}ej  and  Chatterjee, Rajen  and  Federmann, Christian  '
            'and  Haddow, Barry  and  Huck, Matthias  and  Hokamp, Chris  and'
            '  Koehn, Philipp  and  Logacheva, Varvara  and  Monz, Christof  '
            'and  Negri, Matteo  and  Post, Matt  and  Scarton, Carolina  and'
            '  Specia, Lucia  and  Turchi, Marco},\n  title     = {Findings of'
    ...
    'wmt14': {
        ...
        'citation':
            ...
            'Ondrej  and  Buck, Christian  and  Federmann, Christian  and  '
            'Haddow, Barry  and  Koehn, Philipp  and  Leveling, Johannes  and'
            '  Monz, Christof  and  Pecina, Pavel  and  Post, Matt  and  '
            'Saint-Amand, Herve  and  Soricut, Radu  and  Specia, Lucia  and  '
    ...
    'wmt14/full': {
        ...
        'description':
            'Evaluation data released after official evaluation for further '
            'research.',
        'cs-en': [
    ...
    'wmt11': {
        ...
        'citation':
            ...
            '{Callison-Burch, Chris  and  Koehn, Philipp  and  Monz, Christof'
            '  and  Zaidan, Omar},\n  title     = {Findings of the 2011 '
            'Workshop on Statistical Machine Translation},\n  booktitle = '
            '{Proceedings of the Sixth Workshop on Statistical Machine '
            'Translation},\n  month     = {July},\n  year      = {2011},\n  '
    ...
    'iwslt17': {
        ...
        'citation':
            ...
            'Federico, Marcello and Bentivogli, Luisa and Niehues, Jan and '
            'Stüker, Sebastian and Sudoh, Katsuitho and Yoshino, Koichiro and '
            'Federmann, Christian},\n  title     = {Overview of the IWSLT 2017'
...
def download_test_set(test_set, langpair=None):
  ...
  expected_checksums = DATASETS[test_set].get('md5',
                                              [None] * len(DATASETS[test_set]))
...
def main():
  ...
  sys.stdin = open(
      ...
      newline='\n')
  sys.stdout = open(
      sys.stdout.fileno(), mode='w', encoding='utf-8', buffering=True)
  ...
  if args.test_set and (args.langpair is None or
                        args.langpair not in DATASETS[args.test_set]):
  ...
  for metric in args.metrics:
    if metric == 'bleu':
      if args.score_only:
        ...
        print(
            'BLEU+{0} = {1:.{2}f} {3:.1f}/{4:.1f}/{5:.1f}/{6:.1f} (BP = {7:.3f} ratio = {8:.3f} hyp_len = {9:d} ref_len = {10:d})'
            .format(version_str, bleu.score, width, bleu.precisions[0],
                    bleu.precisions[1], bleu.precisions[2], bleu.precisions[3],
                    bleu.bp, bleu.sys_len / bleu.ref_len, bleu.sys_len,
                    bleu.ref_len))
      ...
      if args.score_only:
        ...
        print('chrF{0:d}+{1} = {2:.{3}f}'.format(args.chrf_beta, version_str,
                                                 chrf, width))
